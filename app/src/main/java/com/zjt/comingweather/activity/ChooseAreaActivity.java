...
public class ChooseAreaActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        comingWeatherDB = comingWeatherDB.getInstance(this);
    ...
    private void queryProvinces() {
        provinceList = comingWeatherDB.loadProvinces();
    ...
    private void queryCities() {
        cityList = comingWeatherDB.loadCities(selectedProvince.getId());
        if (cityList.size() > 0) {
            dataList.clear();
    ...
    private void queryCounties() {
        countyList = comingWeatherDB.loadCounties(selectedCity.getId());
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)) {
                    ...
                    result = Utility.handleCitiesResponse(comingWeatherDB, response, selectedProvince.getId());
                } else if ("county".equals(type)) {
                    result = Utility.handleCountiesResponse(comingWeatherDB, response, selectedCity.getId());
                }
                if (result) {
                    //回到主线程处理逻辑
